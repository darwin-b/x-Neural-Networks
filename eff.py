...
#
#
#    Design and training the network in table 1 of the paper with the standard inverted
#    residual building block in fig 2a 
#
#
...
# creating necessary parameters to the init function to create the model defined
# in table 1 of the paper
